...
# Apps in the dock
gsettings set org.gnome.shell favorite-apps "['firefox_firefox.desktop', 'google-chrome.desktop', 'org.gnome.Nautilus.desktop', 'code.desktop', 'org.wireshark.Wireshark.desktop', 'org.gnome.Terminal.desktop']"
